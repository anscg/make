...
module PublicIdentifiable
  ...
  included do
    ...
    # So `project_path(project)` emits the prefixed public id, never the bigint.
    # Defined on the class because `Hashid::Rails` also defines `to_param` and,
    # being included after this module, would otherwise win.
